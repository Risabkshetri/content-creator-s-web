      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl">
            Capturing moments, creating memories, and sharing stories through the lens of creativity.
          </p>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-1">
                <p className="text-gray-600 mb-4">
                  Hi! I&apos;m Jane, a passionate content creator with over 5 years of experience in photography, videography, and digital storytelling. My mission is to help brands and individuals bring their vision to life through compelling visual content.
                </p>
                <p className="text-gray-600">
                  Whether it&apos;s through stunning photographs, engaging videos, or creative social media campaigns, I strive to create content that captivates and connects with audiences.
                </p>
              </div>
              <motion.div
